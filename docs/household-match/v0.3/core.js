(function(root){
'use strict';
const LEVELS=[{rows:2,cols:4,score:10,limit:6},{rows:2,cols:5,score:20,limit:7},{rows:3,cols:4,score:30,limit:8},{rows:3,cols:6,score:40,limit:11},{rows:4,cols:5,score:50,limit:12},{rows:4,cols:6,score:60,limit:14}];
