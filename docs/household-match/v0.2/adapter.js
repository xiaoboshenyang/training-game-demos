...
const shell=createGameShell({mount:$('#mount'),mode:'playtest',config:{templateVersion:'1.1.0',title:'日用品翻牌配对',background:'assets/wood.jpg',clock:'external',feedbackDurationMs:1500},adapter});
