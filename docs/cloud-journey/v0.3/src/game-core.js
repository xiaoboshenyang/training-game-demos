(function attachCloudJourneyCore(root, factory) {
  ...
  const CONFIG = Object.freeze({
    ...
    levels: Object.freeze({
      1: Object.freeze({ gap: 400, interval: 4, kinds: [0.5, 0.5, 0], singleDepth: Object.freeze([220, 300]), movingChance: 0, maxMoving: 0, coinInterval: 4, maxCenterDelta: HEIGHT * 0.15 }),
      2: Object.freeze({ gap: 360, interval: 3.2, kinds: [0.3, 0.3, 0.4], singleDepth: Object.freeze([280, 370]), movingChance: 0, maxMoving: 0, coinInterval: 3, maxCenterDelta: HEIGHT * 0.25 }),
      3: Object.freeze({ gap: 340, interval: 2.7, kinds: [0.25, 0.25, 0.5], singleDepth: Object.freeze([280, 370]), movingChance: 0, maxMoving: 0, coinInterval: 3, maxCenterDelta: HEIGHT * 0.3 }),
      4: Object.freeze({ gap: 320, interval: 2.35, kinds: [0.15, 0.15, 0.7], movingChance: 0.2, maxMoving: 1, moveAmplitude: 20, movePeriod: 7, coinInterval: 2, maxCenterDelta: HEIGHT * 0.35 }),
      5: Object.freeze({ gap: 310, interval: 2.2, kinds: [0.125, 0.125, 0.75], movingChance: 0.35, maxMoving: 2, moveAmplitude: 30, movePeriod: 6, coinInterval: 2, maxCenterDelta: HEIGHT * 0.375 }),
      6: Object.freeze({ gap: 300, interval: 2.1, kinds: [0.1, 0.1, 0.8], movingChance: 0.5, maxMoving: 2, moveAmplitude: 50, movePeriod: 5, coinInterval: 2, maxCenterDelta: HEIGHT * 0.4 })
    })
  });
  ...
  function applyScoreEvent(score, eventName) {
    const changes = { pass: 10, coin: 30, collision: -10 };
  ...
  function coinOverlapsCloudEnvelope(owner, other) {
    ...
    if (Math.abs(owner.x - other.x) >= CONFIG.obstacleVisualMaxWidth / 2 + 7 + radius) return false;
