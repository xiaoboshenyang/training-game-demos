...
export const FISH_TYPES = Object.freeze({
  big: Object.freeze({
    ...
    crossingSeconds: 8, visualWidth: 136, collisionWidth: 112, collisionHeight: 70,
  }),
  medium: Object.freeze({
    id: 'medium', kind: 'fish', score: 20, relativeSize: 80,
    crossingSeconds: 6.5, visualWidth: 109, collisionWidth: 90, collisionHeight: 58,
  }),
  small: Object.freeze({
    id: 'small', kind: 'fish', score: 30, relativeSize: 64,
    crossingSeconds: 5, visualWidth: 87, collisionWidth: 72, collisionHeight: 46,
  }),
  shark: Object.freeze({
    id: 'shark', kind: 'shark', score: 0, relativeSize: 150,
    crossingSeconds: 6.5, visualWidth: 204, collisionWidth: 168, collisionHeight: 87,
  }),
});
