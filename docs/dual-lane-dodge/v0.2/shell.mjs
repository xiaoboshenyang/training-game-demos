...
export class GameShell{
  ...
  ready(){this.displayPhase='ready';this.show('双路避障','鼠标左键控制左侧，右键控制右侧，可同时按住；按住外移，松开回内。每过一行，观察下一行并换位。','开始 120 秒','<div class="rule-line">躲开整行：单障碍 +5 分，双障碍 +10 分。<br>失误不扣分。连续成功 6 行升级，连续失败 3 行降级。</div>');}
